...
export const plugins: Plugin[] = [
  {
    slug: "image-markup",
    name: "Image Markup",
    tagline: "Review Workspace images with arrows, boxes, notes, and edit briefs.",
    status: "prototype",
    hosts: ["Drive", "Docs", "Slides"],
    summary:
      "A Google Workspace add-on prototype that discovers images in Drive, Docs, and Slides, opens an external canvas editor, and saves annotated PNGs plus structured edit briefs back to Workspace.",
    audience: "Reviewers, designers, marketers, and AI image users who need visual feedback that can be inserted back into Docs, Slides, or Drive.",
    appScriptPath: "plugins/image-markup/appscript",
    features: [
      "Drive contextual image selection with unsupported file handling",
      "Docs inline image scanning with stable generated labels",
      "Slides image element scanning grouped by source slide",
      "External canvas editor with freehand, arrow, rectangle, and text tools",
      "Recent sessions plus Drive, Docs, and Slides write-back actions",
    ],
    setup: [
      ...
      "Deploy a Workspace Add-on test deployment for Drive, Docs, and Slides.",
      "Open /image-markup locally or from an annotation session to test PNG and edit brief export.",
    ],
  },
  {
    slug: "meeting-notes",
